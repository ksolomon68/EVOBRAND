...
</html>`}const ve=(t,i)=>{const a=new Date().toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),o=pe(t,i,a),n=window.open("","_blank","width=900,height=700");if(!n){alert("Please allow popups to download the PDF report.");return}n.document.open(),n.document.write(o),n.document.close(),n.onload=()=>{setTimeout(()=>{n.focus(),n.print()},500)}};export{ye as A,ve as d};
