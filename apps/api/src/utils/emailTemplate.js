...
const getEmailTemplate = (
  ...
  // Strip any hardcoded black text colors generated by WYSIWYG editors so they fall back to theme light text
  const cleanContent = trackedContent.replace(/color\s*:\s*(#000000|#000|rgb\(\s*0\s*,\s*0\s*,\s*0\s*\)|rgba\(\s*0\s*,\s*0\s*,\s*0\s*,\s*1\s*\)|black)\s*;?/gi, '');
